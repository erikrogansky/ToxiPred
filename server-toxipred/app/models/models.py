...
MODELS: dict[str, ModelSpec] = {
    "XGB Corrosion": ModelSpec(
        ...
        note="XGBoost - 23 descriptors, in vitro 3D corrosion",
        explainer="tree",
        ...
        dataset="In Vitro 3D (151 compounds)",
    ),
    ...
    "XGB Phototox 3T3": ModelSpec(
        ...
        kind="pickle",
        note="XGBoost - 52 descriptors + AtomPair fingerprint, in vitro 3T3 phototoxicity",
        explainer="tree",
        feature_source="mixed",
        test_type="in_vitro",
        prediction_target="photo_toxicity",
    ...
    "XGB Phototox 3D": ModelSpec(
        ...
        kind="pickle",
        note="XGBoost - 24 descriptors + RDKit fingerprint (512 bits), in vitro 3D phototoxicity",
        explainer="tree",
        feature_source="mixed",
        test_type="in_vitro",
        prediction_target="photo_toxicity",
    ...
    "GB Irritation (in vitro)": ModelSpec(
        ...
        kind="pickle",
        note="GradientBoosting - 7 descriptors, in vitro 3D skin irritation",
        explainer="tree",
        feature_source="descriptors",
        test_type="in_vitro",
        ...
        classification_threshold=0.5,
        dataset="In Vitro 3D (208 compounds)",
    ),
    ...
    "SVM Phototox (in vivo)": ModelSpec(
        ...
        note="SVM pipeline (SelectFromModel -> SVM) - 223 inputs, 30 selected internally, in vivo phototoxicity",
        explainer="kernel",
        feature_source="mixed",
        test_type="in_vivo",
        prediction_target="photo_toxicity",
